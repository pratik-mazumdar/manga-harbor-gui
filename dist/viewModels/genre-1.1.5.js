  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        genre = getParams(2);
        _context.next = 5;
        return fetch("".concat(urls.api, "/genre/").concat(genre, "/").concat(page));
      case 5:
      ...
      case 8:
        response = _context.sent;
        if (response.back) {
          $(".back").attr("href", "".concat(urls.base, "/genre/").concat(genre, "/").concat(page - 1));
          $(".back").removeClass("hidden");
        }
        if (response.next) {
          $(".next").attr("href", "".concat(urls.base, "/genre/").concat(genre, "/").concat(page + 1));
...
},{"cash-dom":1,"lodash.isnil":2}],7:[function(require,module,exports){
"use strict";
...
function VerboseCard(params) {
  var card = $("<div>").addClass("h-48 cursor-pointer");
  card.on("click", function () {
    return redirectManga(params.id);
  });
  var innerContainer = $("<div>").addClass("w-full h-full bg-base-100 grid grid-cols-3 rounded-lg");
  card.append(innerContainer);
  var image = $("<img>").addClass("h-48 pr-2");
...
function Card(params, currentChapter) {
  var card = $("<div>").addClass("card m-2 p-2 w-48 min-w-48 bg-base-100 shadow-xl cursor-pointer");
  if (params.manga) {
    card.on("click", function () {
      location.href = "".concat(urls.base, "/manga/").concat(params.id);
    });
