...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        page = parseInt(getParams());
        page = defaultTo(page, 1);
        _context.next = 4;
        return fetch("".concat(urls.api, "/latest-manga/").concat(page));
      case 4:
      ...
      case 7:
        response = _context.sent;
        if (response.back) {
          $(".back").attr("href", "".concat(urls.base, "/latest-manga/").concat(page - 1));
          $(".back").removeClass("hidden");
        }
        if (response.next) {
          $(".next").attr("href", "".concat(urls.base, "/latest-manga/").concat(page + 1));
