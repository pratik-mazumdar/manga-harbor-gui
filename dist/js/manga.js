...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var params, mangaId, disqus_config, d, s, response, manga_details, chapters, elements, summary, summaryText, readMoreLink, readLessLink, truncatedSummary;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        params = new URLSearchParams(location.search);
        mangaId = params.get("id"); // eslint-disable-next-line no-unused-vars
      ...
      case 27:
        ...
        readMoreLink = __("read-more-link");
        readLessLink = __("read-less-link");
