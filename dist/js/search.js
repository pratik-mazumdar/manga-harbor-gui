...
function createCard(params) {
  ...
  var title = $("<div>").addClass("flex mb-3 font-sans font-bold pt-3 pb-2");
    ...
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        if (page === null) page = 1;else if (page !== "1") {
          $(".back").each(function (ele) {
            $(ele).remove("hidden");
            $(ele).attr("href", "".concat(urls.search, "?s=").concat(search, "&p=").concat(page - 1));
          });
        }
        $(".next").each(function (ele) {
          $(ele).attr("href", "".concat(urls.search, "?s=").concat(search, "&p=").concat(parseInt(page) + 1));
        });
        _context.next = 7;
