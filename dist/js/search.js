...
function redirectManga(id) {
  location.href = "manga?id=".concat(id);
}
function searchBar() {
  var searchForm = __("searchForm");
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            searchValue = __("search").value;
            window.location = "".concat(urls.search, "?p=1&s=").concat(encodeURIComponent(searchValue));
          case 3:
          case "end":
...
function createCard(params) {
  ...
  innerContainer.className = "w-full h-full bg-gray-700 grid grid-cols-2 rounded-lg";
  ...
  status.innerHTML = "<span class=\"text-xs font-semibold mb-2\">Status: ".concat(params.status, "</span>");
  detailsContainer.appendChild(status);
  var author = document.createElement("div");
  author.className = "flex ";
  author.innerHTML = "<span class=\"text-xs font-semibold mb-2\">Author: ".concat(params.author, "</span>");
  detailsContainer.appendChild(author);
  var genre = document.createElement("div");
  genre.className = "flex text-sm";
  genre.innerHTML = "<span class=\"text-xs font-semibold mb-2\"> Genre: ".concat(params.genre, "</span>");
  detailsContainer.appendChild(genre);
  var lastUpdated = document.createElement("div");
  lastUpdated.className = "flex text-sm";
  lastUpdated.innerHTML = "<span class=\"text-xs font-semibold mb-2\">Last Updated: ".concat(transformDate(params.lastUpdated), "</span>");
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var params, page, search, response, mangaList, cardsContainer;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        page = params.get("p");
        search = params.get("s");
        if (page === null) page = 1;else if (page !== "1") {
          document.querySelectorAll(".back").forEach(function (ele) {
            ele.classList.remove("hidden");
            ele.href = "".concat(urls.search, "?s=").concat(search, "&p=").concat(page - 1);
          });
        }
        document.querySelectorAll(".next").forEach(function (ele) {
          ele.href = "".concat(urls.search, "?s=").concat(search, "&p=").concat(parseInt(page) + 1);
        });
        _context.next = 7;
      ...
      case 10:
        mangaList = _context.sent.mangaList;
        cardsContainer = __("cards");
