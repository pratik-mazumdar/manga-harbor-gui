  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        nextPageLink = document.querySelectorAll(".next");
        previousPageLink = document.querySelectorAll(".back");
        if (page !== 0) {
          previousPageLink.forEach(function (backButton) {
            backButton.classList.remove("hidden");
            backButton.href = "".concat(urls.home, "?page=").concat(page - 1);
          });
        }
        nextPageLink.forEach(function (nextButton) {
          nextButton.href = "".concat(urls.home, "?page=").concat(page + 1);
        });
        _context.next = 8;
