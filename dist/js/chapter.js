...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var mangaId, chapterIndex, disqus_config, d, s, chapterList, chapter, response, links, imageTags;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        mangaId = getParams(2); //19e506asdfe116-4458-b031-kjadsfjsdafj
        ...
        __("current_manga_link").href = "".concat(urls.base, "/manga?id=").concat(mangaId);
        _context.next = 17;
